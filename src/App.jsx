...
function Logo({ onClick, height = 28 }) {
  return (
        ...
        {!pedidoPendiente && !tarjetaPagoData ? (
          ...
          <div ref={tarjetaContainerRef}>
            ...
            <div style={{ border: `1px solid ${GRAY2}`, borderRadius: 10, overflow: "hidden" }}>
              <iframe srcDoc={tarjetaPagoData.RedirectData} frameBorder="0" title="Pago con tarjeta" style={{ width: "100%", height: "min(560px, 75vh)", display: "block" }} />
            </div>
